<form action="/process.php" method="POST">
    <div class="row mb-3 mt-3">
        ...
        <div class="col">
            <input type="number" name="numbers" class="form-control" placeholder="Enter number">
        </div>
    </div>
    <div class="row mb-3 mt-3">
        <div class="col">
    ...
    <div class="mb-3">
        <textarea  placeholder="Enter message" name="messages" class="form-control"></textarea>
    </div>
    <div class="d-grid">
